...
class Farm extends Component {
  ...
  async loadBlockchainData() {
    ...
    // Load StakingToken
    const stakingTokenAddr = await this.state.tokenFarm.methods
      .stakingToken()
      .call();
    ...
    if (stakingTokenAddr) {
      ...
      let stakingTokenBalance = await stakingToken.methods
        .balanceOf(this.state.account)
        .call();
    ...
    // Load RewardToken
    const rewardTokenAddr = await this.state.tokenFarm.methods
      .rewardToken()
      .call();
    ...
    if (rewardTokenAddr) {
      ...
      let rewardTokenBalance = await this.state.tokenFarm.methods
